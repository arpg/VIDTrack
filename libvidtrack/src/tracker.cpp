                          ...
                          const ba::Options<double>& options)
{
  if (config_ba_) {
    ...
    // by BA.
    // NOTE(jfalquez): When using cameras.xml files generated by Vicalib, IMU is
    // considered the "world" origin.
...
//  std::cout << "Cov:" << std::endl << dtrack_covariance << std::endl;
  ...
  new_dtrack_covariance.setZero();
  new_dtrack_covariance(0,0) = dtrack_covariance(2,2) / 2.0;
  new_dtrack_covariance(0,1) = dtrack_covariance(2,0);
  new_dtrack_covariance(0,2) = dtrack_covariance(2,1);
  new_dtrack_covariance(0,3) = dtrack_covariance(2,5);
  new_dtrack_covariance(0,4) = dtrack_covariance(2,3);
  new_dtrack_covariance(0,5) = dtrack_covariance(2,4);
  new_dtrack_covariance(1,1) = dtrack_covariance(0,0) / 2.0;
  new_dtrack_covariance(1,2) = dtrack_covariance(0,1);
  new_dtrack_covariance(1,3) = dtrack_covariance(0,5);
  new_dtrack_covariance(1,4) = dtrack_covariance(0,3);
  new_dtrack_covariance(1,5) = dtrack_covariance(0,4);
  new_dtrack_covariance(2,2) = dtrack_covariance(1,1) / 2.0;
  new_dtrack_covariance(2,3) = dtrack_covariance(1,5);
  new_dtrack_covariance(2,4) = dtrack_covariance(1,3);
  new_dtrack_covariance(2,5) = dtrack_covariance(1,4);
  new_dtrack_covariance(3,3) = dtrack_covariance(5,5) / 2.0;
  new_dtrack_covariance(3,4) = dtrack_covariance(5,3);
  new_dtrack_covariance(3,5) = dtrack_covariance(5,4);
  new_dtrack_covariance(4,4) = dtrack_covariance(3,3) / 2.0;
  new_dtrack_covariance(4,5) = dtrack_covariance(3,4);
  new_dtrack_covariance(5,5) = dtrack_covariance(4,4) / 2.0;
  dtrack_covariance = new_dtrack_covariance + new_dtrack_covariance.transpose();
